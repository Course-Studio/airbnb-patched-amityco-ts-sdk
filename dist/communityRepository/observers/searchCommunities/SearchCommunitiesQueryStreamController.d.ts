...
export declare class CommunitiesQueryStreamController extends QueryStreamController<Amity.CommunityPayload, Amity.SearchCommunityLiveCollection> {
    private notifyChange;
    private preparePayload;
    constructor(query: Amity.SearchCommunityLiveCollection, cacheKey: string[], notifyChange: (params: Amity.LiveCollectionNotifyParams) => void, preparePayload: (response: Amity.CommunityPayload) => Amity.ProcessedCommunityPayload);
...
//# sourceMappingURL=SearchCommunitiesQueryStreamController.d.ts.map