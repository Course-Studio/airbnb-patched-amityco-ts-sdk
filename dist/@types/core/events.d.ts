...
declare global {
    namespace Amity {
        ...
        type MqttRTE = MqttChannelEvents & MqttSubChannelEvents & MqttMessageEvents & MqttCommunityEvents & MqttPostEvents & MqttCommentEvents & MqttUserEvents & MqttFollowEvents & MqttMarkerEvents & MqttStoryEvents;
        ...
        type LocalEvents = {
            ...
            'local.story.reactionAdded': {
                story: Amity.InternalStory;
            } & {
                reactor: Amity.InternalReactor;
            };
            'local.story.reactionRemoved': {
                story: Amity.InternalStory;
            } & {
                reactor: Amity.InternalReactor;
            };
        ...
        } & LocalPostEvents & LocalCommentEvents & LocalCommunityEvents & LocalFollowEvents;
