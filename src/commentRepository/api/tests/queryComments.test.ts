...
const queryParams: mockParamAndResponse = {
  ...
  response: textCommentPayload.comments.map(comment => LinkedObject.comment(comment)),
};
...
const queryImageOnly: mockParamAndResponse = {
  ...
  response: imageCommentPayload.comments.map(comment => LinkedObject.comment(comment)),
};
...
const queryImageAny: mockParamAndResponse = {
  ...
  response: textAndImageCommentMixedPayload.comments.map(comment => LinkedObject.comment(comment)),
};
...
const queryWithParentId: mockParamAndResponse = {
  ...
  response: comment12Payload.comments.map(comment => LinkedObject.comment(comment)),
};
...
const deletedComment: mockParamAndResponse = {
  ...
  response: deletedCommentPayload.comments.map(comment => LinkedObject.comment(comment)),
};
